...
jindo.$Except={CANNOT_USE_OPTION:"�대�� �듭���� �ъ�⑺�� �� ���듬����.",CANNOT_USE_HEADER:"type�� jsonp�쇰�� header硫������� �ъ�⑺�� �� ���듬����.",PARSE_ERROR:"���깆� ���ш� 諛������듬����.",NOT_FOUND_ARGUMENT:"���쇰��곌� ���듬����.",NOT_STANDARD_QUERY:"css�����곌� �������댁� ���듬����.",INVALID_DATE:"��吏� �щĸ�� ��������.",REQUIRE_AJAX:"媛� ���듬����.",NOT_FOUND_ELEMENT:"��由щ㉫�멸� ���듬����.",HAS_FUNCTION_FOR_GROUP:"洹몃９�쇰� 吏��곗� ���� 寃쎌�� detach�� �⑥��媛� ���댁�� �⑸����.",NONE_ELEMENT:"�� �대�뱁���� ��由щ㉫�멸� ���듬����.",NOT_SUPPORT_SELECTOR:"�� 吏�����吏� ���� selector������.",NOT_SUPPORT_METHOD:"desktop���� 吏�����吏� ���� 硫����� ������.",JSON_MUST_HAVE_ARRAY_HASH:"get硫������� json������ hash�� array����留� 媛��ν�⑸����.",MUST_APPEND_DOM:"document�� 遺�吏� ���� ��由щ㉫�몃�� 湲곗� ��由щ㉫�몃� �ъ�⑺�� �� ���듬����.",NOT_USE_CSS:"�� css瑜� �ъ�� ���� ���듬����.",NOT_WORK_DOMREADY:"domready�대깽�몃�� iframe������ �ъ�⑺�� �� ���듬����."};
...
jindo.$Jindo._maxWarn=function(nCurrentLength,nMaxLength,sMessage){if(nCurrentLength>nMaxLength){jindo.$Jindo._warn("異�媛����� ���쇰��곌� ���듬����. : "+sMessage)
}};
...
var fpErrorMessage=function(sUsed,aSuggs,sURL){var aMsg=["��紐삳�� ���쇰�명�곗������.",""];
if(sUsed){aMsg.push("�몄��� ���� :");
aMsg.push("\t"+sUsed);
aMsg.push("")
}if(aSuggs.length){aMsg.push("�ъ�� 媛��ν�� ���� :");
for(var i=0,nLen=aSuggs.length;
i<nLen;
i++){aMsg.push("\t"+aSuggs[i])
}aMsg.push("")
}if(sURL){aMsg.push("留ㅻ�댁�� ���댁� :");
aMsg.push("\t"+sURL);
aMsg.push("")
}aMsg.unshift();
return aMsg.join("\n")
...
}}).extend(jindo.UIComponent);var lcs_add={};
...
switch(type){case 0:sDefaultImage="http://static.naver.net/movie/2012/06/dft_img30x43.png";
break;
case 1:sDefaultImage="http://static.naver.net/movie/2012/06/dft_img30x48.png";
break
...
}else{jindo.$Element("jAutoComplate").prepend(jindo.$('<p id="jInfomation" class="at_alert">�������� 湲곕�μ�� ���깊�������듬����.</p>'))
}}catch(e){}},0)
};
...
var sHTML="";
switch(value[6][0]){case"movie":sHTML=template.auto_mv_contents.replace(/{{title}}/g,value[0][0]).replace("{{title_match}}",self.makeAutoText(query,value[0][0])).replace("{{time}}",value[1][0].slice(0,4)).replace("{{people}}",value[2][0]).replace("{{thumbnail}}",(value[3][0])?value[3][0]+"?type=n30_43_2":"http://static.naver.net/movie/2012/06/dft_img30x43.png").replace("{{link}}",options.movelink+value[5][0]);
break;
case"people":break;
}return sHTML
...
var img="";
var title="";
switch(sStat){case"show":img="http://static.naver.net/movie/2012/06/srch_arrow_up.gif";
title="�������� ��湲�";
break;
case"hide":img="http://static.naver.net/movie/2012/06/srch_arrow_down.gif";
title="�������� �쇱�湲�";
break;
case"off":img="http://static.naver.net/movie/2012/06/srch_arrow_down2.gif";
title="�������� 耳�湲�";
break
