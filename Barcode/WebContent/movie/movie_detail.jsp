...
<%}%>
	...
	<div id="header" style="bottom: 0px;">
		<a href="http://movie.naver.com/movie/bi/mi/basic.nhn?code=152385#content" title="본문으로 이동" class="blind">본문 바로가기</a>
		<h1 class="svc_name">
			...
			<div class="scrollbar-box" style="width: 148px; height: 891px;">
				<div class="scrollbar-content" style="top: 0px; width: 148px; height: auto;">
                    <div class="in_scroll">
                        <ul class="navi">
                        <li>
                            <a href="http://movie.naver.com/" title="영화홈" class="menu01"><strong>영화홈</strong></a><!-- N=a:LNB.home -->
                        </li>
                        <li>
                            <a href="http://movie.naver.com/movie/running/current.nhn" title="상영작·예정작" class="menu02_on"><strong>상영작·예정작</strong></a><!-- N=a:LNB.movies -->
                            <ul class="navi_sub" id="navi_movie" style="display: block;">
<%if(count<=0) {%>
                            <li><a href="http://movie.naver.com/movie/running/current.nhn" title="현재 상영영화" class="sub2_1_on"><em>현재 상영영화</em></a><!-- N=a:LNB.now --></li>
...
<%}else {%>
                            ...
                            <li><a href="http://movie.naver.com/movie/running/premovie.nhn" title="개봉 예정영화" class="sub2_2_on"><em>개봉 예정영화</em></a><!-- N=a:LNB.soon --></li>
<%} %>
                            </ul>
                        </li>
                        <li>
...
<div class="wide_info_area" style="display: none;">
	<!-- 포스터 -->
	<div class="poster">
				<a href="http://movie.naver.com/movie/bi/mi/basic.nhn?code=152385#" onclick="javascript:common.iwopen(&#39;152385&#39;);clickcr(this,&#39;ifo.img&#39;,&#39;&#39;,&#39;&#39;,event);return false;"><img src="./movie_detail_files/movie_image.jpg" alt="<%=title%>" onerror="this.src=&#39;http://static.naver.net/movie/2012/06/dft_img77x110_1.png&#39;"><span>포스터 크게보기</span></a>
	</div>
	<!-- //포스터 -->
	<div class="mv_info">
		<h3 class="h_movie">
...
<%} %>
		...
		<div class="main_score">
				<div class="score">
					<div class="uio_ntz_btn see">
						<span class="ntz _actualPointHelpWide">
							...
							<a href="http://movie.naver.com/movie/bi/mi/basic.nhn?code=152385#" id="actualPointHelpButtonWide" class="help _actualPointHelpWide">관람객 평점 도움말</a>
						</span>
					...
					<a id="actualPointPersentWide" href="http://movie.naver.com/movie/bi/mi/point.nhn?code=152385&amp;onlyActualPointYn=Y#pointAfterTab" class="ntz_score">
				...
				<div class="score">
					<div class="spc_score_area">
						<a href="http://movie.naver.com/movie/bi/mi/point.nhn?code=152385#pointExpertTab" class="spc">
			...
			<div class="score">
				<div class="uio_ntz_btn">
					<span class="ntz">
						<em class="blind">네티즌 평점</em><a href="http://movie.naver.com/movie/bi/mi/basic.nhn?code=152385#" class="help" id="pointHelpButtonWide" title="네티즌 평점 도움말 보기">네티즌 평점 도움말</a>
					</span>
				...
				<div class="star_score ">
					<a id="pointNetizenPersentBasic">
						<span class="st_off"><span class="st_on" style="width:<%=star*10%>%"></span></span>
			...
			<div id="noPointWide" class="score">
				<div class="my_score_area">
					...
					<a href="http://movie.naver.com/movie/bi/mi/point.nhn?code=152385#pointAfterTab">
		...
		<div class="info_spec2">
			...
			<div class="end_btn_area">
				<ul>
					<li><a href="http://movie.naver.com/movie/bi/mi/reserve.nhn?code=152385" title="예매하기" class="btn_rsv _reserveHelpWide" id="reserveWide"><em>예매하기</em></a>
						<div class="ly_mileage _reserveHelpWide" id="reserveHelpWide" style="display:none">
							<span></span>영화관람후 평점을 작성하시면 <em>바코드페이 포인트 500원</em>을 드립니다! <a href="http://movie.naver.com/movie/bi/mi/basic.nhn?code=152385#" id="reserveHelpWideCloseButton" class="btn_close _reserveHelpWide"><em>닫기</em></a>
						</div>
					</li>
...
<%} %>
		...
		<div class="main_score">		
			<div class="score score_left">
				<div class="uio_ntz_btn">
					<span class="ntz">
						<em class="blind">네티즌 평점</em><a href="http://movie.naver.com/movie/bi/mi/basic.nhn?code=152385#" class="help" id="pointHelpButtonBasic" title="네티즌 평점 도움말 보기">네티즌 평점 도움말</a>
					</span>
...
<%if(num.equals("1")) {%>
						...
						<li>
							...
							<div class="score_reple">
								...
								<dl>
									<dt>
										<em>
											<a href="http://movie.naver.com/movie/bi/mi/basic.nhn?code=152385#" onclick="javascript:showPointListByNid(13418993);return false;">
												<span>et45****</span>
											</a>
										</em>
									...
									<dd>
										<a href="http://movie.naver.com/movie/bi/mi/basic.nhn?code=152385#" onclick="javascript:common.report(&#39;false&#39;,&#39;et45****&#39;, &#39;SSZMFHAcKvLAGCmrlA5QtvP6TsB6X21Ag4Zy18YYzig=&#39;, &#39;진자  사기꾼이네요ㅋㅋ 제가사기당한거같아요 &#39;, &#39;13418993&#39;, &#39;point_after&#39;, true);return false;" class="go_report2"><em>신고</em></a><!-- N=a:mra.report -->
									</dd>
								</dl>
							</div>
							<div class="btn_area">
								<a class="_sympathyButton" href="http://movie.naver.com/movie/bi/mi/basic.nhn?code=152385#"><span class="blind">공감</span></a><!-- N=a:mra.sym --><strong><span class="sympathy_13418993 count">2233</span></strong>
								<a class="_notSympathyButton" href="http://movie.naver.com/movie/bi/mi/basic.nhn?code=152385#"><span class="blind">비공감</span></a><!-- N=a:mra.opp --><strong><span class="notSympathy_13418993 count v2">391</span></strong>
							</div>
						</li>
					</ul>
				</div>
	...
	<div class="section_group"  id="3">
		...
		<div class="obj_section">
			<div class="review">
				<div class="title_area">
					<a href="http://movie.naver.com/movie/bi/mi/review.nhn?code=152385#reviewTab">
					...
					<div class="review_good ">
						...
						<ul class="rvw_list_area rvw_list_mv">
								...
								<li>
									<a href="http://movie.naver.com/movie/bi/mi/reviewread.nhn?code=152385&amp;nid=4578391"><strong>&lt;꾼&gt; 야 이 사기꾼들!!!! 내 두시간을!!!!</strong><em class="hot">HOT</em></a><!-- N=a:mre.title -->
									<span class="user"><a href="http://movie.naver.com/movie/board/review/list.nhn?st=nickname&amp;sword=4578391">acts****</a><!-- N=a:mre.uid --> <em>2017.11.14</em><em><span>추천</span> 10</em></span>
									<p><a href="http://movie.naver.com/movie/bi/mi/reviewread.nhn?code=152385&amp;nid=4578391">        꾼      감독   장창원   출연   현빈, 유지태, 배성우, 박성웅, 나나, 안세하   개봉   2017 대한민국   평점                         리뷰보기         20171114왕십리 CGV 8-C-11익무인나눔 시사회2.5/5 ‘희대...</a><!-- N=a:mre.content --></p>
								</li>
							
								<li>
									<a href="http://movie.naver.com/movie/bi/mi/reviewread.nhn?code=152385&amp;nid=4580360"><strong>[영화감상] <%=title%> (The Swindlers, 2017) </strong></a><!-- N=a:mre.title -->
									<span class="user"><a href="http://movie.naver.com/movie/board/review/list.nhn?st=nickname&amp;sword=4580360">sakg****</a><!-- N=a:mre.uid --> <em>2017.11.22</em><em><span>추천</span> 9</em></span>
									<p><a href="http://movie.naver.com/movie/bi/mi/reviewread.nhn?code=152385&amp;nid=4580360">어제 저녁 퇴근길에 들려서 '대구 CGV'에서 보고 온 '꾼'입니다..벌써 개봉했어? 하시겟지만, '유료시사회'였다는 ㅋㅋㅋㅋ정식개봉은 오늘일듯 싶어요..원래 제가 이런 '사기꾼'나오는 영화들 좋아해서, 넘 보고싶었는데.....</a><!-- N=a:mre.content --></p>
								</li>
					...
					<div class="review_bad">
						...
						<ul class="rvw_list_area rvw_list_mv">
								...
								<li>
									<a href="http://movie.naver.com/movie/bi/mi/reviewread.nhn?code=152385&amp;nid=4580778#tab"><strong><%=title%> : 유행(※사회비판)에 편승하느라 장르적 쾌감을 잃어버린 케이퍼 무비</strong><em class="hot">HOT</em></a>
									<span class="user"><a href="http://movie.naver.com/movie/board/review/list.nhn?st=nickname&amp;sword=4580778">c106****</a> <em>2017.11.23</em><em><span>추천</span> 38</em></span>
									<p><a href="http://movie.naver.com/movie/bi/mi/reviewread.nhn?code=152385&amp;nid=4580778#tab">장창원 감독 / 117분 / 15세 관람가현빈, 유지태, 배성우, 박성웅, 나나, 안세하..개인적인 평점 : 4점 (오락성 4점, 작품성 4점)     안녕하세요? 오늘은 어제(22일) 메가박스 북대구에서 관람하고 온 &lt;<%=title%>&gt; 이야기를...</a></p>
								</li>
							
								<li>
									<a href="http://movie.naver.com/movie/bi/mi/reviewread.nhn?code=152385&amp;nid=4578736#tab"><strong>얼개가 꾸역꾸역 억지스러워요.</strong></a>
									<span class="user"><a href="http://movie.naver.com/movie/board/review/list.nhn?st=nickname&amp;sword=4578736">alho****</a> <em>2017.11.16</em><em><span>추천</span> 15</em></span>
									<p><a href="http://movie.naver.com/movie/bi/mi/reviewread.nhn?code=152385&amp;nid=4578736#tab">반전이 있을 거란 예감이 계속 드는데 그걸 위한 복선이 너무 찌질찌질해요.범죄의 재구성처럼 연출에서 긴박감이 더 있었으면 좋았을 거 같아요. 아니면 반전을 납득할만한 개연성이 있던가요. 모든 얼개가 잘 안 맞아 떨...</a></p>
								</li>
						</ul>
					</div>
			</div>
	...
	<div class="section_group section_group_frst">
		...
		<div class="obj_section noline">
			<div class="ifr_module2">
				<iframe src="./point.html" id="pointAfterListIframe" name="pointAfterListIframe" width="100%" frameborder="0" scrolling="no" class="ifr" title="네티즌 평점 리스트" height="1434px"></iframe>
			</div>
		</div>
	</div>
