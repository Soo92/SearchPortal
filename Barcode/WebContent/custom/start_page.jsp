...
<link rel="stylesheet" type="text/css" href="./네이버 고객센터_files/help.css">
<script type="text/javascript">
	var topPath = "/support/";
	var ccsrv = "cc.naver.com";
</script>
<script type="text/javascript"
	src="./네이버 고객센터_files/jquery-1.10.2.js.다운로드"></script>
<script type="text/javascript" src="./네이버 고객센터_files/common.js.다운로드"></script>
<script type="text/javascript" src="./네이버 고객센터_files/clickcr.js.다운로드"></script>
...
<script src="./네이버 고객센터_files/clickcrD.js.다운로드" id="gnb_clickcrD"
...
<body style="">
	<div id="wrap">
		...
		<script type="text/javascript" src="./네이버 고객센터_files/search.js.다운로드"></script>
		<div id="header">
			<div class="gnb_area">
				<div class="Ngnb">
			...
			<div class="content_wrap svs">
				<div class="snb">
					...
					<div class="nav">
						...
						<h4 class="back_prv">
							<a
								href="https://help.naver.com/support/contents/contents.nhn?serviceNo=1074&amp;categoryNo=16690#"
	...
	jQuery().ready(function(){
		if (jQuery('.on a').height() > 16 && jQuery('.on a').height() <= 32) {
			...
			jQuery('.on').addClass('l3');
				...
				<script type="text/javascript"
					src="./네이버 고객센터_files/jindo.textcheck.js.다운로드"></script>
				<div id="content">
							...
							<div class="svs_end_cont">
								...
								<p>
									<img
										...
										alt="익스플로러24" src="./네이버 고객센터_files/시작페이지.png" border="1"
										attachimageno="2218">
								</p>
								<p>
								...
								<p>
									<img
										style="border: 1px solid rgb(154, 154, 154); border-image: none;"
										alt="익스플로러25" src="./네이버 고객센터_files/시작페이지2.png" border="1"
										attachimageno="2219">
								</p>
								<p>
...
<script type="text/javascript"
	src="./네이버 고객센터_files/flashObject.js.다운로드">
</script>
<script type="text/javascript">
	jQuery(document).ready(function(){
							...
							<div class="info info_v2">
								...
								<div id="mapPopup" class="map_popup" style="display: none">
									<div class="con">
										...
										<div class="mapinfo">
											<div>
												<img src="./네이버 고객센터_files/img_new_map_v2.jpg" width="368"
								...
								<address>
									ⓒ <a href="http://www.navercorp.com/ko/index.nhn">Barcode
										Corp.</a> <a href="http://www.navercorp.com/ko/index.nhn"
										class="f_logo_naver"><img
										src="./네이버 고객센터_files/logo_ci.png" width="63" height="11"
										alt="NAVER"></a>
								</address>
							</div>
							<script>
	...
	jQuery(document).on("click", "#arsPopup .btn_confirm, #arsPopup .btn_close", function () {
		jQuery("#arsPopup").hide();
					...
					<script type="text/javascript"
						src="./네이버 고객센터_files/lcslog.js.다운로드"></script>
					<script type="text/javascript">
