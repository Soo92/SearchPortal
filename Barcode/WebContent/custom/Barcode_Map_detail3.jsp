...
<jsp:useBean id="cmgr" class="member.MapCustomMgr"/>
<jsp:useBean id="cbean" class="member.MapCustomBean"/>
<%
	...
	cbean=cmgr.getMember(index);
	String cate0=cbean.getCate0();
	String cate1=cbean.getCate1();
	String cate2=cbean.getCate2();
	String cname=cbean.getName();
	String regdate=cbean.getRegdate();
	String count=cbean.getCount();
	String content=cbean.getContent();
%>
<!DOCTYPE html>
<!-- saved from url=(0083)https://help.naver.com/support/contents/contents.nhn?serviceNo=768&categoryNo=18897 -->
<html xmlns="http://www.w3.org/1999/xhtml" lang="ko">
<head>
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
<meta property="og:title" content="바코드 고객센터">

<meta property="og:description" content="실내지도란 무엇인가요?">
...
<link rel="stylesheet" type="text/css"
	href="./Barcode_Map_detail3_files/help.css">
...
<script type="text/javascript"
	src="./Barcode_Map_detail3_files/jquery-1.10.2.js.다운로드"></script>
<script type="text/javascript"
	src="./Barcode_Map_detail3_files/common.js.다운로드"></script>
<script type="text/javascript"
	src="./Barcode_Map_detail3_files/clickcr.js.다운로드"></script>

<style id="gnb_style" type="text/css">
@charset "UTF-8";
/* NTS UIT Development Office YJH 140717 */
a.gnb_my, .gnb_icon, #gnb .gnb_my_interface, #gnb .gnb_ico_num .gnb_ico_new,
	#gnb .gnb_ico_num .gnb_ico_new .gnb_count, .gnb_lst .ico_arrow, a.gnb_my .filter_mask,
	.gnb_my_lyr, .gnb_my_li .gnb_my_content .gnb_mask, .gnb_my_li .gnb_my_content .gnb_change,
	.gnb_my_li .gnb_my_content .gnb_edit_lst li, .gnb_my_li .gnb_my_content .gnb_pay_check em,
	#gnb .gnb_my_li .gnb_my_community a.gnb_pay span, .gnb_notice_li .gnb_notice_lyr,
...
<script src="./Barcode_Map_detail3_files/clickcrD.js.다운로드"
...
<body style="">
	<div id="wrap">
		<div id="u_skip">
			<a
				href="https://help.naver.com/support/contents/contents.nhn?serviceNo=768&amp;categoryNo=18897#content"
		...
		<script type="text/javascript"
			src="./Barcode_Map_detail3_files/search.js.다운로드"></script>
		<script type="text/javascript">
								...
								<ul class="gnb_lst" id="gnb_lst" style="display: block;">
									...
									<li class="gnb_my_li" id="gnb_my_layer" style="display: none"><div
											...
											<a href="javascript:;" class="gnb_my"
												...
												href="https://help.naver.com/support/contents/contents.nhn?serviceNo=768&amp;categoryNo=18897#"
												class="gnb_emp" id="gnb_emp">(임직원혜택)</a>
										</div>
										<div class="gnb_my_lyr" id="gnb_my_lyr">
												...
												<div class="gnb_txt_area">
													<p class="gnb_account">
														<span class="gnb_name" id="gnb_name2"><a
															...
															class="gnb_btn_login"
															href="https://nid.naver.com/nidlogin.logout?returl=https%3A%2F%2Fhelp.naver.com%2Fsupport%2Fcontents%2Fcontents.nhn%3FserviceNo%3D768%26categoryNo%3D18897"
											...
											<a
												href="https://help.naver.com/support/contents/contents.nhn?serviceNo=768&amp;categoryNo=18897#"
												class="gnb_my_interface" style="display: none"><span
										...
										<iframe id="gnb_my_lyr_iframe" title="빈 프레임"
											...
											src="./Barcode_Map_detail3_files/saved_resource.html"></iframe></li>
									...
									<div class="gnb_notice_lyr" id="gnb_notice_lyr">
										...
										<iframe id="gnb_notice_lyr_iframe" title="빈 프레임"
											...
											src="./Barcode_Map_detail3_files/saved_resource(1).html"></iframe></li>
									...
									<div class="gnb_service_lyr" id="gnb_service_lyr">
											<div class="gnb_favorite_search" id="gnb_favorite_search">
												<div class="gnb_favorite_area">
													<div class="gnb_favorite_lstwrp">
														...
														<ul class="gnb_favorite_lst" id="gnb_favorite_lst">
															<li class="gnb_add"><a
																href="https://help.naver.com/support/contents/contents.nhn?serviceNo=768&amp;categoryNo=18897#"><span
												...
												<div class="gnb_banner">
													<a href="http://campaign.naver.com/pointevent/"
														...
														src="./Barcode_Map_detail3_files/promo_npay_1712.png"></a>
												</div>
										...
										<iframe id="gnb_service_lyr_iframe" title="빈 프레임"
											...
											src="./Barcode_Map_detail3_files/saved_resource(2).html"></iframe>
										<iframe id="gnb_svc_more_iframe" title="빈 프레임"
											class="gnb_pad_lyr" name="padding" width="0" height="0"
											scrolling="no" frameborder="0"
											style="display: none; top: 55px; right: 10px; width: 295px; height: 385px; opacity: 0;"
											src="./Barcode_Map_detail3_files/saved_resource(3).html"></iframe></li>
								</ul>
							</div>
						</div>
					</div>
				...
				<div class="snb">
					...
					<div class="nav">
						...
						<h4 class="back_prv">
							<a
								href="https://help.naver.com/support/contents/contents.nhn?serviceNo=768&amp;categoryNo=18897#"
								onclick="return CATEGORY.change(&#39;768&#39;, &#39;1096&#39;, &#39;VC01&#39;, &#39;&#39;, &#39;GRP01&#39;, event)"><span
								class="ic_prv" ></span><%=cate1 %></a>
						</h4>
						...
						<ul>
							...
							<li class="on"><a href="Barcode_Map_detail3.jsp"><%=cate2 %></a></li>
	...
	jQuery().ready(function(){
		if (jQuery('.on a').height() > 16 && jQuery('.on a').height() <= 32) {
			...
			jQuery('.on').addClass('l3');
				...
				<script type="text/javascript"
					src="./Barcode_Map_detail3_files/jindo.textcheck.js.다운로드"></script>
				<div id="content">
					<div class="ctg_section">
						<div class="pnt_ctg_area">
							...
							<ul>
								<li><a
									href="https://help.naver.com/support/contents/contents.nhn?serviceNo=768&amp;categoryNo=18897#"
									onclick="return SERVICE.goService(&#39;768&#39;, &#39;LINK01&#39;, &#39;&#39;, &#39;ctn.navi&#39;, event)"
									title=<%=cate0 %>><%=cate0 %></a></li>
								...
								<li><a
									href="https://help.naver.com/support/contents/contents.nhn?serviceNo=768&amp;categoryNo=18897#"
									onclick="CATEGORY.change(&#39;768&#39;, &#39;1096&#39;, &#39;VC01&#39;, &#39;&#39;, &#39;&#39;, event, &#39;ctn.navi&#39;)"
									title=<%=cate1 %>><%=cate1 %></a></li>





								<li class="last"><strong title=<%=cate2 %>><%=cate2 %></strong></li>
							</ul>
						</div>
						<div class="svs_end_area">
							<!-- [D] 현재 선택된 타이틀 적용 -->
							<h1 class="blind">실내지도란 무엇인가요?</h1>
							<!-- [D] 본문 페이지일 경우 클래스 cont 추가 -->
							<table class="cmn_table cont">
								<!-- [D] 현재 선택된 타이틀 적용 -->
								<caption>실내지도란 무엇인가요?</caption>
								<colgroup>
									<col>
								...
								<tbody>
									<tr>
										<td><span class="atcl"><%=cname %></span></td>
										<td><%=regdate %></td>
										<td><%=count %></td>
									</tr>
								</tbody>
							...
							<!-- [D] 본문 상세 타이틀 적용 -->
							<h2 class="blind">실내지도란 무엇인가요?</h2>
							<div class="svs_end_cont">
								<%=content %>
								<p>
									<b>&lt;실내지도 이용방법&gt;</b>
								</p>
								<p>실내지도를 볼 수 있는 건물은 지도화면에서 영역으로 표시되며</p>
								<p>영역위에 마우스를 올리면 해당 건물에 대한 이름이 나오고</p>
								<p>클릭하면 실내지도로 쉽게 진입할 수 있습니다.</p>
								<p>&nbsp;</p>
								<p>지도화면 우측의 레벨조절바 또는 마우스휠로 특정 실내지도를 확대하시면</p>
								<p>모든 매장과 시설물의 위치를 자세하게 확인할 수 있습니다.</p>
								<p>&nbsp;</p>
								<p>
									<img alt="실내지도"
										src="./Barcode_Map_detail3_files/1435649628358020.png"
										attachimageno="9369">
								</p>
								<p>&nbsp;</p>
								<p>&nbsp;</p>
								<p class="MsoNormal" style="MARGIN: 0cm 0cm 0pt">
									<b style="mso-bidi-font-weight: normal"><span lang="EN-US"
										style="FONT-SIZE: 9pt; FONT-FAMILY: &amp; #39;돋움&amp;#39;,Dotum,Sans-serif">&lt;</span></b><b
										style="mso-bidi-font-weight: normal"><span
										style="FONT-SIZE: 9pt; FONT-FAMILY: &amp; #39;돋움&amp;#39;,Dotum,Sans-serif">층이동
											및 업체<span lang="EN-US"
											style="FONT-SIZE: 9pt; FONT-FAMILY: &amp; #39;돋움&amp;#39;,Dotum,Sans-serif">/</span>편의시설
											정보<span lang="EN-US"
											style="FONT-SIZE: 9pt; FONT-FAMILY: &amp; #39;돋움&amp;#39;,Dotum,Sans-serif">&gt;<o:p></o:p></span>
									</span></b>
								</p>
								<p class="MsoNormal" style="MARGIN: 0cm 0cm 0pt">
									<span
										style="FONT-SIZE: 9pt; FONT-FAMILY: &amp; #39;돋움&amp;#39;,Dotum,Sans-serif">여러
										층의 실내지도를 제공하는 경우 좌측 하단에 층이동 버튼이 제공되어 </span>
								</p>
								<p class="MsoNormal" style="MARGIN: 0cm 0cm 0pt">
									<span
										style="FONT-SIZE: 9pt; FONT-FAMILY: &amp; #39;돋움&amp;#39;,Dotum,Sans-serif"></span><span
										style="FONT-SIZE: 9pt; FONT-FAMILY: &amp; #39;돋움&amp;#39;,Dotum,Sans-serif">원하는
										층을 선택할 수 있으며 </span><span style="FONT-SIZE: 9pt; FONT-FAMILY: 나눔고딕"><span
										style="FONT-SIZE: 9pt; FONT-FAMILY: &amp; #39;돋움&amp;#39;,Dotum,Sans-serif">입점업체
											및 편의시설 정보를 </span></span>
								</p>
								<p class="MsoNormal" style="MARGIN: 0cm 0cm 0pt">
									<span style="FONT-SIZE: 9pt; FONT-FAMILY: 나눔고딕"><span
										style="FONT-SIZE: 9pt; FONT-FAMILY: &amp; #39;돋움&amp;#39;,Dotum,Sans-serif">한눈에
											볼 수 있는 버튼도 제공 됩니다</span><span lang="EN-US"><span
											style="FONT-SIZE: 9pt; FONT-FAMILY: &amp; #39;돋움&amp;#39;,Dotum,Sans-serif">.
										</span>
										<o:p></o:p></span></span>
								</p>
								<p>&nbsp;</p>
								<p>
									<img alt="실내지도2"
										src="./Barcode_Map_detail3_files/1435649696823086.png"
										attachimageno="9370">
								</p>
								<p>&nbsp;</p>
								<p>실내지도 및 실내뷰 기능은 PC웹 지도, 모바일 지도앱 iOS 버전으로 제공되며,</p>
								<p>모바일 지도앱 안드로이드 버전은 향후 제공될 예정입니다.</p>
								<p>
									<br>
								</p>
								<p>&nbsp;</p>
							...
							<script type="text/javascript">
						jQuery(function() {
							jQuery("#btn_question").click(function(event){
								window.open("http://kin.naver.com/qna/question.nhn?dirId=1060104&d1Id=1" + "&enc=utf8&serviceId=webhelp");
...
jQuery(document).ready(function(){
	...
	jQuery("#closeKinPopup").click(function(event){
		...
		<script type="text/javascript"
			src="./Barcode_Map_detail3_files/flashObject.js.다운로드"></script>
		<script type="text/javascript">
	jQuery(document).ready(function(){
			...
			<div class="con">
				...
				nhn.FlashObject.show("/support/static/player.swf", "player", 720, 405, param, "middle", "11,3,378,5");
					...
					<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000"
						...
						class="F1513216225961958570_undefined"
		...
		<div id="footer">
			...
			<div class="info info_v2">
				<a
					href="https://help.naver.com/support/contents/contents.nhn?serviceNo=768&amp;categoryNo=18897#mapPopup"
				...
				<div id="mapPopup" class="map_popup" style="display: none">
					<div class="con">
						...
						<div class="mapinfo">
							<div>
								<img src="./Barcode_Map_detail3_files/img_new_map_v2.jpg"
									width="368" height="323" alt="고객센터 지도">
							</div>
							<p class="map_address">
				...
				<address>
					ⓒ <a href="../index.jsp">Barcode Corp.</a> <a href="../index.jsp"
						class="f_logo_naver"><img src="logo_ci.png" width="63"
						height="11" alt="NAVER"></a>
				</address>
			</div>
			<script>
	...
	<script type="text/javascript"
		src="./Barcode_Map_detail3_files/lcslog.js.다운로드"></script>
	<script type="text/javascript">
