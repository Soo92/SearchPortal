...
%>
<!DOCTYPE html>
<!-- saved from url=(0061)https://help.naver.com/support/service/main.nhn?serviceNo=768 -->
<html xmlns="http://www.w3.org/1999/xhtml" lang="ko"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
		...
		<meta property="og:title" content="바코드 고객센터">
			...
			<meta property="og:description" content="바코드 고객센터를 통해 각 서비스 도움말을 확인해보세요.">
...
<meta property="og:type" content="website">
	...
	<link rel="shortcut icon" type="image/x-icon" href="https://ssl.pstatic.net/static/help/common/favicon.ico">
		...
		<link rel="stylesheet" type="text/css" href="./Barcode_Map_files/help.css">
...
<script type="text/javascript" src="./Barcode_Map_files/jquery-1.10.2.js.다운로드"></script>
<script type="text/javascript" src="./Barcode_Map_files/common.js.다운로드"></script>
<script type="text/javascript" src="./Barcode_Map_files/clickcr.js.다운로드"></script>
...
#gnb.gnb_one_flat .gnb_login_li .gnb_btn_login .gnb_txt {color: #777;}</style><script src="./Barcode_Map_files/clickcrD.js.다운로드" id="gnb_clickcrD" charset="utf-8"></script></head>
...
<div id="wrap">
	<div id="u_skip">
    	...
    	<a href="https://help.naver.com/support/service/main.nhn?serviceNo=768#content" onclick="document.getElementById(&#39;content&#39;).tabIndex=-1;document.getElementById(&#39;content&#39;).focus();return false;">본문 바로가기</a>
...
<script type="text/javascript" src="./Barcode_Map_files/search.js.다운로드"></script>
<script type="text/javascript">
...
<div class="nav">
	...
	<ul>
		...
		<li><a href="./Barcode_Map_detail.jsp" >실내지도/뮤지엄뷰</a></li>
...
<div id="content">
    	        ...
    	        <div class="kwd_typ_section">
    	            ...
    	            <li>
    	                <img src="./Barcode_Map_files/1387531007254028.jpg" width="130" height="92" alt="이용방법" class="thumb">
    	                <dl>
                        <dt>이용방법</dt>
                        <!-- [D] 시스텝폰트 기준 띄어쓰기 포함 최대 31자 노출 -->
								...
								<dd><a href="./Barcode_Map_detail2.jsp" > 범례에 대해 알고 싶어요.<span class="ic"></span></a></dd>
								...
								<dd><a href="./Barcode_Map_detail2.jsp" >지도 검색 자동완성 기능은 무엇인가요?<span class="ic"></span></a></dd>
								...
								<dd><a href="./Barcode_Map_detail2.jsp" ">지도 즐겨찾기와 홈 설정 하기 활용하는 방법을 알고 싶어요.<span class="ic"></span></a></dd>
    	            ...
    	            <li>
    	                <img src="./Barcode_Map_files/1387531099211074.jpg" width="130" height="92" alt="거리뷰.항공뷰" class="thumb">
    	                <dl>
                        <dt>거리뷰.항공뷰</dt>
                        <!-- [D] 시스텝폰트 기준 띄어쓰기 포함 최대 31자 노출 -->
								...
								<dd><a href="./Barcode_Map_detail2.jsp" ">거리뷰/항공뷰 화면이 보이지 않을때 해결 방법은 무엇인가요?<span class="ic"></span></a></dd>
								...
								<dd><a href="./Barcode_Map_detail2.jsp" >개인정보 및 군사시설이 노출되어 업데이트가 필요합니다.<span class="ic"></span></a></dd>
								...
								<dd><a href="./Barcode_Map_detail2.jsp" >거리뷰 이미지를 최근의 것으로 업데이트 해주세요. <span class="ic"></span></a></dd>
    	            ...
    	            <li>
    	                <img src="./Barcode_Map_files/1387531255211002.jpg" width="130" height="92" alt="주요 문제 해결" class="thumb">
    	                <dl>
                        <dt>주요 문제 해결</dt>
                        <!-- [D] 시스텝폰트 기준 띄어쓰기 포함 최대 31자 노출 -->
								...
								<dd><a href="./Barcode_Map_detail2.jsp" ></span></a></dd>
								...
								<dd><a href="./Barcode_Map_detail2.jsp" >대중교통 정보 수정요청<span class="ic"></span></a></dd>
    ...
    <div class="ly_kin_bridge" style="display:none">
        <div class="con">
            ...
            <a id="closeKinPopup" href="https://help.naver.com/support/service/main.nhn?serviceNo=768#" class="close"><span class="blind">닫기</span></a>
        </div>
    </div>
	<!-- //layer kin bridge -->
<script>
...
<script type="text/javascript" src="./Barcode_Map_files/flashObject.js.다운로드"></script>
<script type="text/javascript">
	jQuery(document).ready(function(){
...
<div id="kinPartnerLayout" class="ly_kin_partner" style="display:none">
	<div class="con">
		...
		<div class="kin_mov">
			...
			</script><object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" codebase="http://fpdownload.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=11,3,378,5" class="F1513211440178533132_undefined" style="position:relative !important;" "="" width="720" height="405" id="player" align="middle"><param name="movie" value="/support/static/player.swf"><param name="quality" value="high"><param name="bgColor" value="#FFFFFF"><param name="allowScriptAccess" value="always"><param name="wmode" value="window"><param name="menu" value="false"><param name="allowFullScreen" value="true"><param name="flashVars" value="isautoplay=false&amp;imgurl=https://ssl.pstatic.net/static/help/support/img_pnmov.jpg&amp;flvurl=/support/static/kin_partner.flv&amp;volume=0.2&amp;contentWidth=720&amp;contentHeight=405&amp;__flashID=player"><embed width="720" height="405" name="player" class="F1513211440178533132_undefined" style="position:relative !important;" "="" src="/support/static/player.swf" align="middle" quality="high" bgcolor="#FFFFFF" allowscriptaccess="always" wmode="window" menu="false" allowfullscreen="true" flashvars="isautoplay=false&amp;imgurl=https://ssl.pstatic.net/static/help/support/img_pnmov.jpg&amp;flvurl=/support/static/kin_partner.flv&amp;volume=0.2&amp;contentWidth=720&amp;contentHeight=405&amp;__flashID=player" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer"></object>
		</div>
		<!-- //동영상영역 -->
	...
	<div id="footer">
		...
		<div class="info info_v2">
			<a href="https://help.naver.com/support/service/main.nhn?serviceNo=768#mapPopup" class="v_map" id="openMap">위치안내</a>
            <!-- [D] 위치안내 클릭시 display:block 변경 -->
            <div id="mapPopup" class="map_popup" style="display:none">
                <div class="con">
                    <p class="tit"><strong>고객센터 위치안내</strong></p>
                    <div class="mapinfo">
                        <div><img src="./Barcode_Map_files/img_new_map_v2.jpg" width="368" height="323" alt="고객센터 지도"></div>
                    ...
                    <div class="btn_area"><a id="closeMap" href="https://help.naver.com/support/service/main.nhn?serviceNo=768#" class="btn_confrm">확인</a></div>
                </div>
...
<script type="text/javascript" src="./Barcode_Map_files/lcslog.js.다운로드"></script>
<script type="text/javascript">
