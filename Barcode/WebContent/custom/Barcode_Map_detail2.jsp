...
%>
<!DOCTYPE html>
<!-- saved from url=(0082)https://help.naver.com/support/contents/contents.nhn?serviceNo=768&categoryNo=1107 -->
<html xmlns="http://www.w3.org/1999/xhtml" lang="ko"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
		...
		<meta property="og:description" content="일반지도/자전거지도 범례에 대해 알고 싶어요.">
...
<meta property="og:type" content="website">
	...
	<link rel="shortcut icon" type="image/x-icon" href="https://ssl.pstatic.net/static/help/common/favicon.ico">
		...
		<link rel="stylesheet" type="text/css" href="./Barcode_Map_detail2_files/help.css">
...
<script type="text/javascript" src="./Barcode_Map_detail2_files/jquery-1.10.2.js.다운로드"></script>
<script type="text/javascript" src="./Barcode_Map_detail2_files/common.js.다운로드"></script>
<script type="text/javascript" src="./Barcode_Map_detail2_files/clickcr.js.다운로드"></script>
...
#gnb.gnb_one_flat .gnb_login_li .gnb_btn_login .gnb_txt {color: #777;}</style><script src="./Barcode_Map_detail2_files/clickcrD.js.다운로드" id="gnb_clickcrD" charset="utf-8"></script></head>
...
<div id="wrap">
	<div id="u_skip">
    	...
    	<a href="https://help.naver.com/support/contents/contents.nhn?serviceNo=768&amp;categoryNo=1107#content" onclick="document.getElementById(&#39;content&#39;).tabIndex=-1;document.getElementById(&#39;content&#39;).focus();return false;">본문 바로가기</a>
...
<script type="text/javascript" src="./Barcode_Map_detail2_files/search.js.다운로드"></script>
<script type="text/javascript">
	    ...
	    <div class="gnb_area">
	    	<div class="Ngnb">
	    		<div class="Ngnb_inner">
	    			...
	    			<h1 class="Ngnb_service"><a href="custom_home.jsp" class="Nhome_link"><span class="Nhome">고객센터</span></a></h1>
...
<h2>
		...
		<a href="https://help.naver.com/support/service/main.nhn?serviceNo=768" onclick="clickcr(this, &#39;ctg.home&#39;, &#39;&#39;, &#39;&#39;, event);" title="지도">지도</a>
...
<div class="nav">
	...
	<h4 class="back_prv"><a href="https://help.naver.com/support/contents/contents.nhn?serviceNo=768&amp;categoryNo=1107#" onclick="return CATEGORY.change(&#39;768&#39;, &#39;13189&#39;, &#39;VC01&#39;, &#39;&#39;, &#39;GRP01&#39;, event)"><span class="ic_prv"></span>범례</a></h4>
	
	
	
	
	<ul>
		<li class="on l2"><a href="Barcode_Map_detail2.jsp">일반지도/자전거지도 범례에 대해 알고 싶어요.</a></li>
		</ul>
</div>
...
<script type="text/javascript" src="./Barcode_Map_detail2_files/jindo.textcheck.js.다운로드"></script>
	<div id="content">
		<div class="ctg_section">
			<div class="pnt_ctg_area">
				<h4 class="blind">카테고리 정보</h4>
				<ul>
					<li><a href="./Barcode_Map_detail.jsp" title="지도">지도</a></li>
					
					
						
					
						<li><a href="./Barcode_Map_detail.jsp" >바코드 지도 보기</a></li>
						...
						<li><a href="./Barcode_Map_detail.jsp" title="범례">범례</a></li>
					
					
					
					
						
					<li class="last"><strong title="일반지도/자전거지도 범례에 대해 알고 싶어요.">일반지도/자전거지도 범례에 대해 알고 싶어요.</strong></li>
			...
			<div class="svs_end_area">
				<!-- [D] 현재 선택된 타이틀 적용 -->
				<h1 class="blind">일반지도/자전거지도 범례에 대해 알고 싶어요.</h1>
				<!-- [D] 본문 페이지일 경우 클래스 cont 추가 -->
				<table class="cmn_table cont">
				<!-- [D] 현재 선택된 타이틀 적용 -->
					<caption>일반지도/자전거지도 범례에 대해 알고 싶어요.</caption>
					<colgroup>
						<col>
					...
					<tbody>
						<tr>
							<td>
								<span class="atcl">일반지도/자전거지도 범례에 대해 알고 싶어요.</span>
							</td>
							<td>2017.11.27</td>
							<td>1</td>
						</tr>
				...
				<!-- [D] 본문 상세 타이틀 적용 -->
				<h2 class="blind">일반지도/자전거지도 범례에 대해 알고 싶어요.</h2>
				<div class="svs_end_cont">
					<p></p><p><strong>[일반지도/자전거지도 범례]</strong></p>
<p><img alt="f" src="./Barcode_Map_detail2_files/1419585532780078.png" attachimageno="7872"></p>
    ...
    <div class="ly_kin_bridge" style="display:none">
        <div class="con">
            ...
            <p class="blind">바코드사용법에 대한 질문/답변이 무려 24만개!! 하루에 새로운 질문 답변이 200개!! 지금 바로 지식iN에서 궁금한 점을 찾아 보세요.</p>
            <a href="http://kin.naver.com/qna/list.nhn?m=noanswer&amp;dirId=10601" onclick="clickcr(this, &#39;kbr.search&#39;, &#39;&#39;, &#39;&#39;, event)" class="srch" target="_blank"><span class="blind">지식iN에서 바코드 사용법 검색하기</span></a>
            <h2 class="blind">찾으시는 내용이 없다면 지식iN에 물어보세요.</h2>
            <p class="blind">다른 이용자와 지식iN 고수들, 바코드 지식파트너가  정확하고 빠르게 답변합니다. 궁금한 점이 있으시면 지금 바로 지식iN에서 질문해 보세요.</p>
            <a href="http://kin.naver.com/qna/question.nhn?dirId=10601&amp;d1Id=1" onclick="clickcr(this, &#39;kbr.ask&#39;, &#39;&#39;, &#39;&#39;, event)" class="ask" target="_blank"><span class="blind">지식iN에서 바코드 사용법 질문하기</span></a>
            <p class="blind">질문 내용을 등록하신 후 ‘바코드사용법’을 선택해주시면  더욱 정확하고 빠르게 답변 받을 수 있어요.</p>
            <p class="blind">예) 지식Q&amp;A &gt; 컴퓨터통신 &gt; 인터넷 &gt; 바코드사용법 &gt; OOO (서비스 명)</p>
            <a id="closeKinPopup" href="https://help.naver.com/support/contents/contents.nhn?serviceNo=768&amp;categoryNo=1107#" class="close"><span class="blind">닫기</span></a>
        </div>
    </div>
	<!-- //layer kin bridge -->
<script>
...
<script type="text/javascript" src="./Barcode_Map_detail2_files/flashObject.js.다운로드"></script>
<script type="text/javascript">
	jQuery(document).ready(function(){
...
<div id="kinPartnerLayout" class="ly_kin_partner" style="display:none">
	<div class="con">
		...
		<div class="kin_mov">
			...
			</script><object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" codebase="http://fpdownload.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=11,3,378,5" class="F1513214600095114634_undefined" style="position:relative !important;" "="" width="720" height="405" id="player" align="middle"><param name="movie" value="/support/static/player.swf"><param name="quality" value="high"><param name="bgColor" value="#FFFFFF"><param name="allowScriptAccess" value="always"><param name="wmode" value="window"><param name="menu" value="false"><param name="allowFullScreen" value="true"><param name="flashVars" value="isautoplay=false&amp;imgurl=https://ssl.pstatic.net/static/help/support/img_pnmov.jpg&amp;flvurl=/support/static/kin_partner.flv&amp;volume=0.2&amp;contentWidth=720&amp;contentHeight=405&amp;__flashID=player"><embed width="720" height="405" name="player" class="F1513214600095114634_undefined" style="position:relative !important;" "="" src="/support/static/player.swf" align="middle" quality="high" bgcolor="#FFFFFF" allowscriptaccess="always" wmode="window" menu="false" allowfullscreen="true" flashvars="isautoplay=false&amp;imgurl=https://ssl.pstatic.net/static/help/support/img_pnmov.jpg&amp;flvurl=/support/static/kin_partner.flv&amp;volume=0.2&amp;contentWidth=720&amp;contentHeight=405&amp;__flashID=player" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer"></object>
		</div>
		<!-- //동영상영역 -->
		<a href="http://kin.naver.com/qna/list.nhn?m=noanswer&amp;dirId=10601" class="btn_drt" onclick="clickcr(this, &#39;rbk.banner&#39;, &#39;&#39;, &#39;&#39;, event)" target="_blank">지식in "바코드 사용법" 바로가기</a>
	...
	<div id="footer">
		...
		<div class="info info_v2">
			<a href="https://help.naver.com/support/contents/contents.nhn?serviceNo=768&amp;categoryNo=1107#mapPopup" class="v_map" id="openMap">위치안내</a>
            <!-- [D] 위치안내 클릭시 display:block 변경 -->
            <div id="mapPopup" class="map_popup" style="display:none">
                <div class="con">
                    <p class="tit"><strong>고객센터 위치안내</strong></p>
                    <div class="mapinfo">
                        <div><img src="./Barcode_Map_detail2_files/img_new_map_v2.jpg" width="368" height="323" alt="고객센터 지도"></div>
                        ...
                        <p class="guide"><span>※</span> <span class="txt">바코드 서비스 관련 궁금하신 점은,<br>고객센터 전화 또는 온라인 고객센터를 통해 해결하실 수 있습니다.</span></p>
                    </div>
                    <div class="btn_area"><a id="closeMap" href="https://help.naver.com/support/contents/contents.nhn?serviceNo=768&amp;categoryNo=1107#" class="btn_confrm">확인</a></div>
                </div>
                <button href="#" class="p_close">고객센터 위치안내 닫기</button>
            </div>
			
            <address>ⓒ <a href="../index.jsp">NAVER Corp.</a> <a href="../index.jsp" class="f_logo_naver"><img src="logo_ci.png" width="63" height="11" alt="NAVER"></a></address>
        </div>
<script>
...
<script type="text/javascript" src="./Barcode_Map_detail2_files/lcslog.js.다운로드"></script>
<script type="text/javascript">
