...
%>
<!DOCTYPE html>
<!-- saved from url=(0077)https://help.naver.com/support/service/main.nhn?serviceNo=768&categoryNo=1096 -->
...
<meta property="og:type" content="website">
	...
	<link rel="shortcut icon" type="image/x-icon" href="https://ssl.pstatic.net/static/help/common/favicon.ico">
		...
		<link rel="stylesheet" type="text/css" href="./Barcode_Map_detail_files/help.css">
...
<script type="text/javascript" src="./Barcode_Map_detail_files/jquery-1.10.2.js.다운로드"></script>
<script type="text/javascript" src="./Barcode_Map_detail_files/common.js.다운로드"></script>
<script type="text/javascript" src="./Barcode_Map_detail_files/clickcr.js.다운로드"></script>
...
#gnb.gnb_one_flat .gnb_login_li .gnb_btn_login .gnb_txt {color: #777;}</style><script src="./Barcode_Map_detail_files/clickcrD.js.다운로드" id="gnb_clickcrD" charset="utf-8"></script></head>
...
<div id="wrap">
	<div id="u_skip">
    	...
    	<a href="https://help.naver.com/support/service/main.nhn?serviceNo=768&amp;categoryNo=1096#content" onclick="document.getElementById(&#39;content&#39;).tabIndex=-1;document.getElementById(&#39;content&#39;).focus();return false;">본문 바로가기</a>
...
<script type="text/javascript" src="./Barcode_Map_detail_files/search.js.다운로드"></script>
<script type="text/javascript">
...
<div class="nav">
	...
	<ul>
		...
		<li class="on"><a href="Barcode_Map_detail.jsp">실내지도/뮤지엄뷰</a></li>
...
<div id="content">
    	        ...
    	        <div class="ctg_section">
    	            <div class="pnt_ctg_area">
    	                ...
    	                <ul>
    	                <li><a href="https://help.naver.com/support/service/main.nhn?serviceNo=768&amp;categoryNo=1096#" onclick="return SERVICE.goService(&#39;768&#39;, &#39;LINK01&#39;, &#39;&#39;, &#39;ctn.navi&#39;, event)" title="지도">지도</a></li>
    	                

	
	
						<li class="last"><strong title="실내지도/뮤지엄뷰">실내지도/뮤지엄뷰</strong></li>  
    	            ...
    	            <div class="nav_area">
    	                <!-- [D] 현재 선택된 타이틀 적용 -->
                        <h4 class="blind">모바일 블로그</h4>
    	                <ul>
    	                <!-- [D] 시스템 폰트 기준 띄어쓰기 포함 최대 46자 노출 -->

    	                <li><a href="Barcode_Map_detail3.jsp?index=1">실내지도란 무엇인가요?</a></li>
    	                <li><a href="Barcode_Map_detail3.jsp">뮤지엄뷰란 무엇인가요?</a></li>
    ...
    <div class="ly_kin_bridge" style="display:none">
        <div class="con">
            ...
            <a id="closeKinPopup" href="https://help.naver.com/support/service/main.nhn?serviceNo=768&amp;categoryNo=1096#" class="close"><span class="blind">닫기</span></a>
        </div>
    </div>
	<!-- //layer kin bridge -->
<script>
...
<script type="text/javascript" src="./Barcode_Map_detail_files/flashObject.js.다운로드"></script>
<script type="text/javascript">
	jQuery(document).ready(function(){
...
<div id="kinPartnerLayout" class="ly_kin_partner" style="display:none">
	<div class="con">
		...
		<div class="kin_mov">
			...
			</script><object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" codebase="http://fpdownload.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=11,3,378,5" class="F151321377612879284_undefined" style="position:relative !important;" "="" width="720" height="405" id="player" align="middle"><param name="movie" value="/support/static/player.swf"><param name="quality" value="high"><param name="bgColor" value="#FFFFFF"><param name="allowScriptAccess" value="always"><param name="wmode" value="window"><param name="menu" value="false"><param name="allowFullScreen" value="true"><param name="flashVars" value="isautoplay=false&amp;imgurl=https://ssl.pstatic.net/static/help/support/img_pnmov.jpg&amp;flvurl=/support/static/kin_partner.flv&amp;volume=0.2&amp;contentWidth=720&amp;contentHeight=405&amp;__flashID=player"><embed width="720" height="405" name="player" class="F151321377612879284_undefined" style="position:relative !important;" "="" src="/support/static/player.swf" align="middle" quality="high" bgcolor="#FFFFFF" allowscriptaccess="always" wmode="window" menu="false" allowfullscreen="true" flashvars="isautoplay=false&amp;imgurl=https://ssl.pstatic.net/static/help/support/img_pnmov.jpg&amp;flvurl=/support/static/kin_partner.flv&amp;volume=0.2&amp;contentWidth=720&amp;contentHeight=405&amp;__flashID=player" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer"></object>
		</div>
		<!-- //동영상영역 -->
	...
	<div id="footer">
		...
		<div class="info info_v2">
			<a href="https://help.naver.com/support/service/main.nhn?serviceNo=768&amp;categoryNo=1096#mapPopup" class="v_map" id="openMap">위치안내</a>
            <!-- [D] 위치안내 클릭시 display:block 변경 -->
            <div id="mapPopup" class="map_popup" style="display:none">
                <div class="con">
                    <p class="tit"><strong>고객센터 위치안내</strong></p>
                    <div class="mapinfo">
                        <div><img src="./Barcode_Map_detail_files/img_new_map_v2.jpg" width="368" height="323" alt="고객센터 지도"></div>
                    ...
                    <div class="btn_area"><a id="closeMap" href="https://help.naver.com/support/service/main.nhn?serviceNo=768&amp;categoryNo=1096#" class="btn_confrm">확인</a></div>
                </div>
                <button href="#" class="p_close">고객센터 위치안내 닫기</button>
            </div>
			
            <address>ⓒ <a href="../index.jsp">Barcode Corp.</a> <a href="../index.jsp" class="f_logo_naver"><img src="logo_ci.png" width="63" height="11" alt="NAVER"></a></address>
        </div>
<script>
...
<script type="text/javascript" src="./Barcode_Map_detail_files/lcslog.js.다운로드"></script>
<script type="text/javascript">
