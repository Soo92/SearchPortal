		...
		r=function(){
			...
			r.prototype.init=function(){
				...
				if(typeof TouchEvent!="undefined"){
					...
					n.slidesContainer
					=n.children().not(".slidesjs-navigation",n).wrapAll("<div class='slidesjs-container'>",n)
					...
					.css({position:"absolute",top:0,left:0,width:"100%",zIndex:0
						,display:"none",webkitBackfaceVisibility:"hidden"});
					e.each(e(".slidesjs-control",n).children()
							,function(t){var n;n=e(this);
				...
				if(this.options.pagination.active){
					...
					r.prototype._setuptouch=function(){
						...
						r.prototype._touchend=function(t){
							...
							s.on("transitionend webkitTransitionEnd" +
