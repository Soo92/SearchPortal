...
<div id="wrap" style="background:#fff;">
	<div id="wrap2">
		<div id="category">
			<a href="#">
			<div id="category_a"><p>패션/뷰티</p></div>
			</a>
			
			<a href="#">
			<div id="category_a" class="space"><p>가전/전자</p></div>
			</a>
			
			<a href="#">
			<div id="category_a" class="space"><p>카메라</p></div>
			</a>
			
			<a href="#">
			<div id="category_a" class="space"><p>스포츠</p></div>
			</a>
			
			<a href="#">
			<div id="category_a" class="space"><p>게임용품</p></div>
			</a>
			
			<a href="#">
			<div id="category_a" class="space"><p>도서</p></div>
			</a>
			
			<a href="#">
			<div id="category_a" class="space"><p>유아/어린이</p></div>
			</a>
