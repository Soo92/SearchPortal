...
<div id="wrap" style="background:#fff;">
	<div id="wrap2">
		<div id="category">
			<a href="#">
			<div id="category_a"><p>신상1</p></div>
			</a>
			
			<a href="#">
			<div id="category_a" class="space"><p>신상2</p></div>
			</a>
			
			<a href="#">
			<div id="category_a" class="space"><p>신상3</p></div>
			</a>
			
			<a href="#">
			<div id="category_a" class="space"><p>신상4</p></div>
			</a>
			
			<a href="#">
			<div id="category_a" class="space"><p>신상5</p></div>
			</a>
			
			<a href="#">
			<div id="category_a" class="space"><p>신상6</p></div>
			</a>
			
			<a href="#">
			<div id="category_a" class="space"><p>신상7</p></div>
			</a>
