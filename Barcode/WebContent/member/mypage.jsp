	...
	<div id="wrap">
		...
		<div id="container" style="height: 749px;">
			...
			<div id="content" class="section_home">
					...
					<div class="sh_group ">
						<div class="sh_header">
							...
							<p class="contxt" id="p_passwd" style="display: none">
								네이버 로그인 시 사용하는 <em>비밀번호를 변경</em>하거나 안전한 로그인을 위한 OTP 로그인 기능을 설정할
											...
											<td>
												<div class="tdcell">
													...
													<p class="contxt_desc">아이디, 비밀번호 찾기 등 본인확인이 필요한 경우 또는
														유료 결제 등 네이버로부터 알림을 받을 때 사용할 휴대전화입니다.</p>
										...
										<tr>
											...
											<td>
												<div class="tdcell">
													...
													<p class="contxt_desc">이벤트 등 다양한 네이버의 소식 및 알림을 받기 위해
														사용할 이메일 주소입니다.</p>
													<p class="contxt_webctrl2">
														<input type="checkbox" id="isEmsCheck" name="isEmsCheck"
															onclick="setEmsCheck();"><label for="isEmsCheck">네이버의
													...
													<p id="p_emsCheck" style="display: none"
														class="contxt_desc">
														네이버페이 서비스는 해당 서비스의 마이페이지에서 수신 여부를 설정할 수 있습니다. 주요 공지사항 및
				...
				<p class="desc_sub">네이버를 더 이상 이용하지 않는다면 
