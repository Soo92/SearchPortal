...
<link rel="stylesheet" href="../css/join_style.css" type="text/css">
...
<body>
	...
	<div id="nav">
		<div id="wrap2">
			<div id="navLeft">
				<ul>
					<li><a href="#">신상품</a></li><li class="ulul" id="aaa">|</li>
					<li class="ulul"><a href="#">중고세상</a></li><li class="ulul" id="aaa">|</li>
					<li class="ulul"><a href="#">영화나라</a></li><li class="ulul" id="aaa">|</li>
					<li class="ulul"><a href="#">예약핵꿀잼</a></li><li class="ulul" id="aaa">|</li>
					<li class="ulul"><a href="#">베스트100</a></li><li class="ulul" id="aaa">|</li>
					<li class="ulul"><a href="#">공지사항</a></li><li class="ulul" id="aaa">|</li>
					<li class="ulul"><a href="#">Q&A </a></li>
				</ul>
			</div>
			<div id="navRight">
				<ul>
